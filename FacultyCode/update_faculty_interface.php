...
<body>
    <div style="margin-top: 20px" class="container">
        ...
        <form action="update_faculty.php" method="post">
            <input type="hidden" name="Fid" id="Fid" value="<?php echo $row['Faculty_id'] ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="department" name="department" value="<?php echo $row['Department'] ?>">
            </div>
            <div class="form-group">
