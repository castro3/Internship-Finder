...
<body>
    <div style="margin-top: 20px" class="container">
        ...
        <div>
            <br>
            <a href="faculty_recommendations.php">Back to Faculty Recommendations</a></br>
        </div>
    ...
    <?php
        ...
        if (isset($_POST['Submit'])){
            ...
            $rarea = isset($_POST['area']) ? $_POST['area'] : " ";
            $rstudentid = isset($_POST['student_id']) ? $_POST['student_id'] : " ";
            $rfacultyid = $_SESSION['id'];
            
            //Insert into Recommendations table;
            
            $query = "INSERT INTO RECOMMENDATIONS VALUES ('".$rid."', '".$rarea."', '".$rfacultyid."', '".$rstudentid."');";

            // The query sent to the DB can be printed by not commenting the following row
            //echo $queryStudent;
            if ($conn->query($query) === TRUE) {
            echo "<br> New record created successfully for recommendation id ".$rid;
            } else {
            ...
            header("Location: faculty_recommendations.php");
}
?>
