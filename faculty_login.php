...
<head>
  ...
  <title>Internship Finder Faculty Login</title>
...
<body>
  <div style="margin-top: 20px" class="container">
    ...
    <a href="create_faculty.php">Don't have an account? Create one now!</a><br><br>
    <div>
        <br>
...
if (!empty($_POST)) {
  if (isset($_POST['Submit'])) {
    ...
    $queryUser = "SELECT * FROM faculty WHERE Faculty_id='" . $input_id . "' AND Email='" . $input_email . "';";
