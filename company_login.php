...
<head>
  ...
  <title>Internship Finder Company Login</title>
...
<body>
  <div style="margin-top: 20px" class="container">
    ...
    <a href="create_company.php">Don't have an account? Create one now!</a><br><br>
    <div>
      <br>
...
if (!empty($_POST)) {
  if (isset($_POST['Submit'])) {
    ...
    $queryUser = "SELECT * FROM company WHERE Company_id='" . $input_id . "' AND Email='" . $input_email . "';";
